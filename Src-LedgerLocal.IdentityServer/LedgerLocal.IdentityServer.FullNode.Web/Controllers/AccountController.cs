...
namespace IdentityServer4.Quickstart.UI
{
    ...
    public class AccountController : Controller
    {
        ...
        public IActionResult Login(string returnUrl)
        {
            ...
            return RedirectToAction("Login", "MemberAccount", new { returnUrl = returnUrl });
        ...
        public async Task<IActionResult> Login(LoginInputModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //await HttpContext.Authentication.SignInAsync(user);
        ...
        {
            return RedirectToAction("ExternalLoginCallback", "MemberAccount", new { returnUrl = returnUrl, remoteError = remoteError });

            //// read external identity from the temporary cookie
            //var info = await HttpContext.Authentication.GetAuthenticateInfoAsync("Identity.External"); //old => ExternalCookieAuthenticationScheme
