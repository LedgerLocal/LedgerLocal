		...
		lazyLoad: function() {
			...
			if( lazyLoadEl.length > 0 ) {
				lazyLoadEl.each( function(){
                    ...
                    element.attr('src', '/assets/llc/images/blank.svg').css({ 'background': 'url(/assets/llc/images/preloader.gif) no-repeat center center #FFF' });
		...
		menufunctions: function(){
			...
			if( $body.hasClass('device-lg') || $body.hasClass('device-md') ) {
				$('#primary-menu.sub-title > ul > li').hover(function() {
                  ...
                  $(this).prev().css({ backgroundImage: 'url("/assets/llc/images/icons/menu-divider.png")' });
				});
