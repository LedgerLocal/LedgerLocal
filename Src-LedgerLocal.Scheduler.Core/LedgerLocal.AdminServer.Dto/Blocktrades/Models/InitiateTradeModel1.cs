...
{ 
    /// <summary>
    /// InitiateTradeModel1 Model
    /// </summary>
    [DataContract]
    public partial class InitiateTradeModel1 : IEquatable<InitiateTradeModel1>
    { 
        /// <summary>
        ...
        /// <summary>
        /// the token identifying the session. If missing, a new user ID will be created
        /// </summary>
        /// <value>the token identifying the session. If missing, a new user ID will be created</value>
        [DataMember(Name="sessionToken")]
        public string SessionToken { get; set; }

        /// <summary>
        /// the uuid associated with an affiliate using our systems
        /// </summary>
        /// <value>the uuid associated with an affiliate using our systems</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InitiateTradeModel1 {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((InitiateTradeModel1)obj);
        }
        ...
        public static bool operator ==(InitiateTradeModel1 left, InitiateTradeModel1 right)
        {
